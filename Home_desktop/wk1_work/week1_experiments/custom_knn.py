...
def main():
	...
	d#f = pd.DataFrame(x_scaled) #Replace df with normalized values
	...
	for record in training_data:
		training[record[-1]].append(record[:-1]) # Append the list in the dict will all the elements of the record except the class
